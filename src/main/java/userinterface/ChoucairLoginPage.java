...
public class ChoucairLoginPage extends PageObject {
    public static final Target LOGIN_BUTTON = Target.the("button that shows us the forms to login").located(By.xpath("//div[@class='d-none d-lg-block]//strong[contains(text(),Ingresar)]"));
